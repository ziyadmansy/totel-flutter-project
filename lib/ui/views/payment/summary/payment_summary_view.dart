...
import 'payment_summary_view_model.dart';

class PaymentSummaryView
    extends ViewModelBuilderWidget<PaymentSummaryViewModel> {
  const PaymentSummaryView({super.key});

  @override
  Widget builder(
      BuildContext context, PaymentSummaryViewModel viewModel, Widget? child) {
    return Scaffold(
      appBar: AppBar(
  ...
  @override
  PaymentSummaryViewModel viewModelBuilder(BuildContext context) =>
